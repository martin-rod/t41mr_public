...
public:
  ...
  template<int BITS,int PX> __attribute__ ((always_inline)) inline void writeBits(uint32_t & next_mark, _outlines & b, PixelController<RGB_ORDER, LANES, __FL_T4_MASK> &pixels) {
        _outlines b2;
