...
void FreqShift1() {
  ...
  // this is for -Fs/4 [moves receive frequency to the right in the
  // spectrumdisplay]
}
...
void FreqShift2() {
  ...
  // if (abs(currentFreqAOld - TxRxFreq) < 9 * ConfigData.stepFineTune &&
  // currentFreqAOld != TxRxFreq) {  // AFP 10-30-22
  //   ShowFrequency();
  //   DrawBandWidthIndicatorBar();
  // }
